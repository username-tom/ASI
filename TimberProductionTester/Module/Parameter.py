...
class Parameter:
    def __init__(self, name=None, address=None, scale=None, units=None,
                 key=None, flash=None, access_level=None, read=None,
                 write=None, value=None, website=None, description=None,
                 index=None, field=None, element=None,
                 enumerations=None, bits=None):
    ...
    def __str__(self):
        return str(self.Name) + " | [" + str(self.Address) + "] = " + str(self.Value)
