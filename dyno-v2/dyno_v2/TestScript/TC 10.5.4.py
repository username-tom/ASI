...
if __name__ == "__main__":
    # TUNABLES:
    peakCurrent: float = 150.0  # rated current in Amps RMS, from product datasheet
    opSpeed = 3000  # RPM
    ...
    # ABB = ABB_ACS800(port='COM5', baud=19200, auto=True)
    ...
    sleep(1)
    dyno = ASIDynoModule(dut, yoko, brake, SSTime, testTime, SSTol, RPMTol, tPID,
